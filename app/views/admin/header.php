...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper">
      <nav style="width:285px; background-image: linear-gradient(to right, #555555, #444444);background-color: #1D2B36;padding-bottom: 400px;" class="sidebar" id="sidebar">
        <ul  class="nav">
          <li style="display: flex;gap: 20px;padding: 20px 50px;align-items: center;" class=" nav-profile">
           
              <div class="nav-profile-image">
                <img width="95px" style="margin-left: -20px;border-radius:10px" margin src="../../../public/img/sach/Logo_nxb_Kim_Đồng.png" alt="profile">
              </div>
              <div class="nav-profile-text d-flex flex-column">
                <span class="text-white font-weight-bold mb-2">Nhóm 8</span>
              </div>
              <i class="mdi mdi-bookmark-check text-success nav-profile-badge"></i>
           
          </li>
          <li style="background-image: linear-gradient(to right, #555555, #444444);background-color: #1D2B36;margin-top: 5%;" class="nav-item">

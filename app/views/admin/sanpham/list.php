<div class="row">
    ...
    <form action="index.php?act=listsp" method="post" class="m-10">
        ...
        <select style="padding:4px ;color:white;background-color: #555555;border-radius: 20px;" name="iddm">
        ...
        <input style="border-radius:50px;padding:5px 10px;background-color:#555555;border:1px solid cadetblue;color:white;" type="submit" name="listok" value="Lọc">
    </form>
